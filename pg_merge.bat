...
for /L %%i in (1, 1, %N_sub_folders%) do (
	...
	call posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% LowerBack %%Eps_merge%% %%PG_dir_dst%% >> posture_graph_merge_parallel_LowerBack.log
	call echo posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% RightArm %%Eps_merge%% %%PG_dir_dst%%
	call posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% RightArm %%Eps_merge%% %%PG_dir_dst%% >> posture_graph_merge_parallel_RightArm.log
	call echo posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% LeftArm %%Eps_merge%% %%PG_dir_dst%%
	call posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% LeftArm %%Eps_merge%% %%PG_dir_dst%% >> posture_graph_merge_parallel_LeftArm.log
	call echo posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% RightUpLeg %%Eps_merge%% %%PG_dir_dst%%
	call posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% RightUpLeg %%Eps_merge%% %%PG_dir_dst%% >> posture_graph_merge_parallel_RightUpLeg.log
	call echo posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% LeftUpLeg %%Eps_merge%% %%PG_dir_dst%%
	call posture_graph_merge_file %%Interests_XML%% %%PG_dir_dst%% %%PG_dir_dst_sub%%\%%List_sub_folders[%%i]%% LeftUpLeg %%Eps_merge%% %%PG_dir_dst%% >> posture_graph_merge_parallel_LeftUpLeg.log
)
